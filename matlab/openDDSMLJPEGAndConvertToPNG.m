...
CollectionDirectory = 'E:\figment.csee.usf.edu\pub\DDSM\cases\set1\';

% These are for the other script. NOTICE THE BRACKETS DIRECTION. ALSO
% NOTICE A SEMICOLON IN FIRST VAR.
pathToJPEGandDDSM2RAWfiles = 'E:/figment.csee.usf.edu/pub/DDSM/cases/set1/;';
  %the conversion script assumes .exe binaries are in the CollectionDirectory
